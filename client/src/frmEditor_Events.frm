...
Begin VB.Form frmEditor_Events 
   ...
   Begin VB.Frame fraDialogue 
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbPlayerSwitchSet 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0004
            Left            =   960
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbSetSelfSwitch 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":001F
            Left            =   1440
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbCondition_Status 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0062
            Left            =   4680
         ...
         Begin VB.ComboBox cmbCondition_Quest 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":008D
            Left            =   1920
         ...
         Begin VB.ComboBox cmbCondition_SkillReq 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":00AD
            Left            =   1920
         ...
         Begin VB.ComboBox cmbCondition_SelfSwitch 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":00CD
            Left            =   1920
         ...
         Begin VB.ComboBox cmbCondition_SelfSwitchCondition 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":00ED
            Left            =   3960
         ...
         Begin VB.ComboBox cmbCondition_LearntSkill 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0108
            Left            =   1920
         ...
         Begin VB.ComboBox cmbCondition_ClassIs 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":010C
            Left            =   1920
         ...
         Begin VB.ComboBox cmbCondition_HasItem 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0110
            Left            =   1920
         ...
         Begin VB.ComboBox cmbCondition_PlayerSwitch 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":012F
            Left            =   1920
         ...
         Begin VB.ComboBox cmbCondition_LevelCompare 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0133
            Left            =   1440
         ...
         Begin VB.ComboBox cmbCondition_PlayerVarCompare 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":01AF
            Left            =   1920
         ...
         Begin VB.ComboBox cmbCondition_PlayerVarIndex 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":022B
            Left            =   1920
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbWarpPlayerDir 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":022F
            Left            =   120
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbPlayAnim 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0283
            Left            =   1680
         ...
         Begin VB.ComboBox cmbPlayAnimEvent 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0287
            Left            =   1920
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbSpawnNPC 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":028B
            Left            =   120
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbOpenShop 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":028F
            Left            =   960
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbPlayBGM 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":032A
            Left            =   1080
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbPlaySound 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":032E
            Left            =   960
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbSetAccess 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0332
            Left            =   960
   ...
   Begin VB.Frame fraGraphic 
      ...
      Begin VB.ComboBox cmbGraphic 
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":0388
         Left            =   720
   ...
   Begin VB.Frame fraMoveRoute 
      ...
      Begin VB.ComboBox cmbEvent 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":03B3
         Left            =   120
   ...
   Begin VB.Frame fraRandom 
      ...
      Begin VB.ComboBox cmbPositioning 
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":03B7
         Left            =   120
   ...
   Begin VB.Frame fraRandom 
      ...
      Begin VB.ComboBox cmbTrigger 
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":0400
         Left            =   120
         List            =   "frmEditor_Events.frx":040D
         Style           =   2  'Dropdown List
         TabIndex        =   25
         Top             =   240
         Width           =   3135
   ...
   Begin VB.Frame fraRandom 
      ...
      Begin VB.ComboBox cmbMoveSpeed 
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":0491
         Left            =   840
         List            =   "frmEditor_Events.frx":04A7
         Style           =   2  'Dropdown List
         TabIndex        =   17
         Top             =   1200
         Width           =   2415
      ...
      Begin VB.ComboBox cmbMoveType 
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":04EA
         Left            =   840
   ...
   Begin VB.Frame fraRandom 
      ...
      Begin VB.ComboBox cmbPlayerVarCompare 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":051F
         Left            =   3720
      ...
      Begin VB.ComboBox cmbSelfSwitchCompare 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":059B
         Left            =   4680
      ...
      Begin VB.ComboBox cmbPlayerSwitchCompare 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":05B6
         Left            =   4680
      ...
      Begin VB.ComboBox cmbHasItem 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":060A
         Left            =   1920
         List            =   "frmEditor_Events.frx":060C
         Style           =   2  'Dropdown List
         TabIndex        =   9
         Top             =   1200
         Width           =   3735
      ...
      Begin VB.ComboBox cmbPlayerSwitch 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":060E
         Left            =   1920
         List            =   "frmEditor_Events.frx":0610
         Style           =   2  'Dropdown List
         TabIndex        =   7
         Top             =   720
         Width           =   2415
      ...
      Begin VB.ComboBox cmbPlayerVar 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":0612
         Left            =   1920
         List            =   "frmEditor_Events.frx":0614
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   240
         Width           =   1455
